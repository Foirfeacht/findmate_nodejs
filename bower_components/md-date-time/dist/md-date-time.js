    ...
    return {
      ...
      controller: [
        '$scope', function(scope) {
          ...
          scope.display = {
            fullTitle: function() {
              return _dateFilter(scope.date, 'EEEE d MMMM yyyy, H:mm');
            },
            title: function() {
              if (scope._mode === 'date') {
                return _dateFilter(scope.date, (scope._displayMode === 'date' ? 'EEEE' : 'EEEE H:mm'));
              } else {
