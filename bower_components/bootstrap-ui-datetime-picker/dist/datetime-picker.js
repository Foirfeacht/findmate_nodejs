        ...
        function ($compile, $parse, $document, $timeout, $position, dateFilter, dateParser, datepickerPopupConfig) {
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                    ...
                    // default text
                    scope.todayText = scope.todayText || 'Сегодня';
                    scope.nowText = scope.nowText || 'Now';
                    scope.clearText = scope.clearText || 'Очистить';
                    scope.closeText = scope.closeText || 'Закрыть';
                    scope.dateText = scope.dateText || 'Дата';
                    scope.timeText = scope.timeText || 'Время';
